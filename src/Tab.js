...
class Tab extends Component {
    render() {
        const { content, isDragging, connectDragSource, connectDropTarget, singleTab } = this.props;
        ...
        return connectDragSource(connectDropTarget(
            <div className={this.props.active ? "react-tabs-tab react-tabs-active" : "react-tabs-tab"}
                 onMouseUp={onClick}>
                <div className="react-tabs-tab-move">×</div>
                <div className="react-tabs-tab-content">{content}</div>
                {!singleTab && (<div className="react-tabs-tab-close" onMouseUp={onClose}>×</div>)}
            </div>,
        ));
    }
}
